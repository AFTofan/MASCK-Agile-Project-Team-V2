    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QrClaims", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QrClaims_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QrClaims_QrCodes_QrCodeId",
                        column: x => x.QrCodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QrClaims_QrCodeId",
                table: "QrClaims",
                column: "QrCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_QrClaims_UserId_QrCodeId",
                table: "QrClaims",
                columns: new[] { "UserId", "QrCodeId" },
                unique: true);
